...
public class DBConfig {
    ...
    public static String INTENT_KEY_CHAT_FRIEND_NAME = "friendName";
    public static String INTENT_KEY_CHAT_FRIEND_AVATAR = "friendAvatar";
    public static String INTENT_KEY_CHAT_FRIEND_ID = "friendID";
