...
import com.example.chattomate.models.ListFriends;

public final class DBFriend {
    private static FriendDBHelper mDbHelper = null;
    private static DBFriend instance = null;

    private DBFriend() { }

    public static DBFriend getInstance(Context context) {
        if (instance == null) {
            instance = new DBFriend();
    ...
    public long addFriend(Friend friend) {
        ...
        values.put(FeedEntry.COLUMN_NAME_ID, friend.idFriend);
    ...
    public void addListFriend(ListFriends listFriend){
        for(Friend friend: listFriend.getListFriend()){
            addFriend(friend);
        }
    }

    public ListFriends getListFriend() {
        ListFriends listFriend = new ListFriends();
...
// you will actually use after this query.
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                friend.idFriend = cursor.getString(0);
